...
- `coach.send_message`
- Description: send message to Self Max guide/coach.
- Input: `{ text }`
- Output: `{ ok, messageId? }`
...
### `route.goals`
- Non-mutating: `goals.list`, `goals.get`, `goals.list_categories`, `coach.read_messages`, `coach.get_last_message`, `ui.get_visibility`
- Mutating: `ui.open_more_menu`, `ui.close_more_menu`, `ui.toggle_goal_list`, `goals.select_category`, `goals.create`, `goals.update`, `goals.start`, `goals.pause`, `goals.complete`, `goals.archive`, `goals.delete`, `goals.run_lifestorming`, `coach.set_draft`, `coach.send_message`, `auth.signout`
...
- Mutating: `lifestorming.open`, `lifestorming.select_category`

### `route.lifestorming_desires_selection`
- Non-mutating: `lifestorming.list_desires`
- Mutating: `lifestorming.select_desire`

### `route.lifestorming_sensation_practice`
- Non-mutating: `lifestorming.get_practice_state`
- Mutating: `lifestorming.next_step`, `lifestorming.previous_step`, `lifestorming.complete_practice`
